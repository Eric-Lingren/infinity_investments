...
class GrowthAllTradesChart extends Component {
    constructor(props){
        super(props)
        this.state = {
            allDailyGrowth: []
    ...
    drawTotalGrowthChart = () => {
        let myTotalGrowthData = this.state.allDailyGrowth
        ...
        let n = myTotalGrowthData.length
        ...
        function mousemove() {   
            ...
            function findIndexValue(d, m){
                yScalePoint = d[m].y
                let moveDecimal = yScalePoint/70
                return moveDecimal
            }
...
export default withTradeHistory(GrowthAllTradesChart)