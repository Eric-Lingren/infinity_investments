...
class Growth2019Chart extends Component {
    ...
    componentWillReceiveProps(nextProps){
        let total2019Growth = nextProps.daily2019Gains 
        if (total2019Growth.length > 0){
            //console.log(nextProps.daily2018Gains)
            this.setState({daily2019Growth: total2019Growth} , () => this.draw2019GrowthChart())
        }
    }

    draw2019GrowthChart = () => {
        let my2019GrowthData = this.state.daily2019Growth
...
export default withTradeHistory(Growth2019Chart)