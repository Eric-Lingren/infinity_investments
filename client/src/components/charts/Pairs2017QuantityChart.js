...
class Pairs2017QuantityChart extends Component {
    constructor(props){
        super(props)
        this.state = {
        }
    ...
    drawPairsTradeQuantityChart = () => {
        ...
        let circles = chart.selectAll('circle')
            .data(this.props.symbols2017TradesCount)
            .enter().append('circle')
        ...
        simulation.nodes(this.props.symbols2017TradesCount)
            .on('tick', ticked)
...
export default withTradeHistory(Pairs2017QuantityChart)